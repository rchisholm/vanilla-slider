...
function Slider(options) {
  ...
  this.slideFadeReplace = function (fadeOutTarget, fadeInTarget) {
    ...
    if (options.waitTime) {
      ...
      setTimeout(function () {
        ...
        _this.slideFadeReplace(fadeOutTarget, fadeInTarget, callback, options);
      }, options.waitTime);
    } else {
      _this.slideFadeOut(fadeOutTarget, function () {
        _this.slideFadeIn(fadeInTarget, callback, options);
      }, options);
    }
  };
  /**
  ...
  this.slideFadeIn = function (fadeInTarget) {
    var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
